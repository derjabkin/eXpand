...
namespace MasterDetailExpand.Module.Win
{
	partial class MasterDetailExpandWindowsFormsModule
	{
		/// <summary> 
		...
		{
			// 
			// MasterDetailExpandWindowsFormsModule
			// 
			this.RequiredModuleTypes.Add(typeof(MasterDetailExpand.Module.MasterDetailExpandModule));
