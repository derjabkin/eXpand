...
{
	public partial class MasterDetailExpandWindowsFormsApplication : XpandWinApplication
	{
		public MasterDetailExpandWindowsFormsApplication()
		{
			InitializeComponent();
		...
		private void MasterDetailExpandWindowsFormsApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e)
		{
#if EASYTEST
			e.Updater.Update();
			e.Handled = true;
