...
namespace MasterDetailExpand.Win
{
	partial class MasterDetailExpandWindowsFormsApplication
	{
		/// <summary> 
		...
		private void InitializeComponent()
		{
			...
			this.module4 = new MasterDetailExpand.Module.Win.MasterDetailExpandWindowsFormsModule();
			...
			// sqlConnection1
			// 
			this.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=MasterDetailExpand;Integrated Security=SSPI;Pooling=f" +
	"alse";
			...
			this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.MasterDetailExpandWindowsFormsApplication_DatabaseVersionMismatch);
		...
		private MasterDetailExpand.Module.Win.MasterDetailExpandWindowsFormsModule module4;
