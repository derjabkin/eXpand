...
namespace MasterDetailExpand.Web
{
	public partial class MasterDetailExpandAspNetApplication : XpandWebApplication
	{
		private DevExpress.ExpressApp.SystemModule.SystemModule module1;
		private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
		private MasterDetailExpand.Module.MasterDetailExpandModule module3;
		private MasterDetailExpand.Module.Web.MasterDetailExpandAspNetModule module4;
		...
		public MasterDetailExpandAspNetApplication()
		{
			InitializeComponent();
		...
		private void MasterDetailExpandAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e)
		{
#if EASYTEST
			e.Updater.Update();
			e.Handled = true;
		...
		private void InitializeComponent()
		{
			...
			this.module3 = new MasterDetailExpand.Module.MasterDetailExpandModule();
			this.module4 = new MasterDetailExpand.Module.Web.MasterDetailExpandAspNetModule();
			...
			// sqlConnection1
			// 
			this.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=MasterDetailExpand;Integrated Security=SSPI;Pooling=" +
	"false";
			...
			// 
			// MasterDetailExpandAspNetApplication
			// 
			this.ApplicationName = "MasterDetailExpand";
			...
			this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.MasterDetailExpandAspNetApplication_DatabaseVersionMismatch);
